...
const double _kMarginBottom = 3.0; //文字和图片的间距
...
class IconTab extends StatefulWidget{
  ...
  final Color color;
  @override
  State<StatefulWidget> createState() => new IconTabState();
}
...
class IconTabState extends State<IconTab>{
  ...
  Widget build(BuildContext context) {
    ...
    Widget label = new Column(
      ...
      children: <Widget>[
        new Container(
          child: new Image(image: new AssetImage(widget.icon),height: 30.0, width: 30.0,),
